...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container2").wowSlider({effect:"blinds",prev:"",next:"",duration:20*100,delay:49*100,width:900,height:300,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:true,captionEffect:"slide",controls:true,logo:"engine2/loading.gif",onBeforeStep:0,images:0});